...
public class Rtest {
	...
	public static void main(String[] args) throws IOException {
		...
		String[] trainArgs = {"-s","3","-c","4096","-g","0.0625","-p","0.5","eunite2001"};//directory of training file'-s 3 -c 4096 -g 0.0625 -p 0.5'
		String modelFile = svm_train.main(trainArgs);
		String[] testArgs = {"eunite2001.t", modelFile, "eunite2001.result"};//directory of test file, model file, result file
